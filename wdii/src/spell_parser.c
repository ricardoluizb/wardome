...
//  skillo(SKILL_FIFTH_ATTACK);
  ...
  spell_level(SKILL_DUAL_WIELD, CLASS_WARRIOR, 20);
  spell_level(SKILL_DUAL_WIELD, CLASS_NINJA, 20);
  spell_level(SKILL_DUAL_WIELD, CLASS_RANGER, 20);
  spell_level(SKILL_DUAL_WIELD, CLASS_BARBARIAN, 20);
